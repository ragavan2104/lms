...
const FrequentlyAccessedResources = () => {
  ...
  const fetchTopBooks = async () => {
    ...
    try {
      ...
      const response = await api.get('/admin/frequently-accessed/top-books', { params });
  ...
  const generateIndividualBookReport = async (bookId, fromSearch = false) => {
    ...
    try {
      ...
      const response = await api.get('/admin/frequently-accessed/book-report', { params });
  ...
  const handleManualBookReport = async () => {
    ...
    try {
      ...
      const searchResponse = await api.get('/admin/frequently-accessed/search', { params });
  ...
  const downloadTopBooksReport = async (format) => {
    try {
      const response = await api.post(`/admin/frequently-accessed/download/${format}`, {
