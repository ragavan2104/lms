...
import { Download, Filter, FileText, IndianRupee, AlertTriangle, BookOpen, Calendar, Search } from 'lucide-react'
...
const PendingReturnsReport = () => {
  ...
  const generateReport = async () => {
    ...
    try {
      ...
      const response = await axios.get(`/admin/reports/pending-returns?${params.toString()}`)
  ...
  const exportReport = async (format) => {
    ...
    try {
      ...
      const response = await axios.get(`/admin/reports/pending-returns/export?${params.toString()}`, {
        responseType: 'blob'
      })
