...
const TransactionStatistics = () => {
  ...
  const fetchDepartments = async (collegeId = null) => {
    try {
      ...
      const response = await api.get('/librarian/departments', { params });
  ...
  const fetchStatistics = async () => {
    ...
    try {
      ...
      const response = await api.get('/librarian/transaction-statistics', { params });
  ...
  const downloadReport = async (format = 'pdf') => {
    try {
      ...
      const response = await api.get('/librarian/transaction-statistics/download', {
        params,
        responseType: 'blob'
      });
